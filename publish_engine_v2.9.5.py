...
def publish_engine():
    ...
    run_cmd(["git", "add", "."])
    run_cmd(["git", "commit", "-m", f"Release Engine v{VERSION} - Silent Updater & Stealth UX"])
    ...
    notes = f"MEJORAS DE SIGILO Y ESTABILIDAD (v{VERSION}).\n- Actualizador 100% silencioso: se eliminó la ventana de CMD visible durante el reinicio.\n- Proceso de reemplazo optimizado: mayor tiempo de espera y reintentos sin 'pause'.\n- Experiencia de usuario premium: el launcher ahora se siente como una aplicación nativa sin ventanas de consola sospechosas.\n- Incluye todos los fixes del Discovery System."

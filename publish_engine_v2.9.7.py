...
def publish_engine():
    ...
    run_cmd(["git", "add", "."])
    run_cmd(["git", "commit", "-m", f"Release Engine v{VERSION} - Absolute Stealth Update"])
    ...
    notes = f"FIX DEFINITIVO DE SIGILO (v{VERSION}).\n- Eliminación absoluta de toda salida de consola en el actualizador.\n- Modo Stealth: Todas las operaciones de archivo redirigidas a NUL.\n- Este paquete garantiza que NINGUNA ventana de CMD aparecerá de nuevo después de esta actualización final."

...
def publish_engine():
    ...
    run_cmd(["git", "add", "."])
    run_cmd(["git", "commit", "-m", f"Release Engine v{VERSION} - Version selector hardening and UI cleanup"])
    ...
    notes = f"KRAKEN Engine v{VERSION} - Versión final de estabilidad y UI.\n- Se mejoró la lógica de selección de versiones en el Profile Editor para soportar labels dinámicos.\n- Se ocultaron paneles de configuración de instancias obsoletos en ConfigView para simplificar la UX.\n- Sincronización completa de versiones en app.manifest y KrakenSetup.iss.\n- Limpieza general de estilos en HubView y MainWindow."
